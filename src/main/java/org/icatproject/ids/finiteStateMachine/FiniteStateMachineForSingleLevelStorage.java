...
public class FiniteStateMachineForSingleLevelStorage
        extends FiniteStateMachine {

    protected FiniteStateMachineForSingleLevelStorage(IcatReader reader,
    ...
    public void queue(DataInfoBase dataInfo, DeferredOp deferredOp)
        ...
        throw new InternalException(
                "### Operation is not permitted for single level storage");
    }
