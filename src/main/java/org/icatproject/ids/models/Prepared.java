...
public class Prepared {
    ...
    public static Prepared unpack(InputStream stream) throws InternalException {
        ...
        var fileLength = pd.containsKey("fileLength")
            ? pd.getInt("fileLength")
            : 0;
        ...
        for (JsonValue itemV : pd.getJsonArray("dfInfo")) {
            ...
            String dfLocation = item.isNull("dfLocation")
                ? null
            ...
            dfInfos.put(
                ...
                new DatafileInfo(
                    dfid,
                    item.getString("dfName"),
                    dfLocation,
                    item.getString("createId"),
                    item.getString("modId"),
        ...
        for (JsonValue itemV : pd.getJsonArray("dsInfo")) {
            ...
            String dsLocation = item.isNull("dsLocation")
                ? null
            ...
            dsInfos.put(
                ...
                new DatasetInfo(
                    dsId,
                    item.getString("dsName"),
                    dsLocation,
                    item.getJsonNumber("invId").longValueExact(),
                    item.getString("invName"),
                    item.getString("visitId"),
