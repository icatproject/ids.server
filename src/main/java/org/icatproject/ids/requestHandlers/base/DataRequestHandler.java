...
public abstract class DataRequestHandler extends RequestHandlerBase {
    ...
    @Override
    protected ValueContainer handleRequest()
        ...
        DataSelectionService dataSelectionService =
            this.dataController.provideDataSelectionService(this.requestType);
    ...
    protected abstract ValueContainer handleDataRequest(
        ...
        throws NotImplementedException, InternalException, BadRequestException, NotFoundException, InsufficientPrivilegesException, DataNotOnlineException;

    @Override
    protected String addParametersToLogString() {
        return (
            this.dataController.addParametersToLogString() +
            " " +
