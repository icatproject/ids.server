...
public abstract class DataControllerBase {
    ...
    public abstract DataSelectionService provideDataSelectionService(
    ...
    public abstract void addParametersToTransmitterJSON(JsonGenerator gen)
            throws IcatException_Exception, BadRequestException;

    public abstract boolean mustZip(boolean zip,
            DataSelectionService dataSelectionService);

    public abstract String getOperationId();

    /**
     * returns the current sessionId. If it's null or not defined it should be
     * created
     *
     * @return
     ...
     *
     * @param thing You can give here a name of the prameter or whatever has
     *              been checked here (to provide a qualified error message if
     *              needed).
     * @param id    The String which has to be checked if it is a valid UUID
     * @throws BadRequestException
     */
    public static void validateUUID(String thing, String id)
            throws BadRequestException {
