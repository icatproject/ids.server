...
public class IdsService {
	...
	public Response getData(@QueryParam("preparedId") String preparedId,
		...
		if (preparedId != null) {
			response = getData(preparedId, outname, offset);
		} else {
			response = getData(sessionId, investigationIds, datasetIds, datafileIds, compress, zip,
					outname, offset);
		}
		return response;
	}
	...
	private void processThrowable(Throwable e) throws InternalException {
