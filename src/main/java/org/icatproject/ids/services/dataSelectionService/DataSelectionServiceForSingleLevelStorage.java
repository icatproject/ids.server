...
public class DataSelectionServiceForSingleLevelStorage
    extends DataSelectionService {

    protected DataSelectionServiceForSingleLevelStorage(
    ...
    public boolean existsInMainStorage(DataInfoBase dataInfo)
        ...
        throw new InternalException(
            "This operation is unavailable for single level storage"
        );
    }
