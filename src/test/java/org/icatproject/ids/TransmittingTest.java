...
/**
 * This test was created when the building of the transmission body was made
 * more comon and generic. It should ensure the right structure of the
 * containing json.
 */
...
public class TransmittingTest {
    ...
    public void testTransmitterBodyForGetSizeRequest_shouldBeOk()
        ...
        var handler = new GetSizeHandler(ip, preparedId, null, null, null,
                null);
        String body = handler.provideTransmissionBody();
    ...
    public void testTransmitterBodyForGetSizeFastRequest_shouldBeOk()
        ...
        var handler = new GetSizeHandlerForFastProcessing(ip, sessionId,
    ...
    public void testTransmitterBodyForDeleteRequest_shouldBeOk()
        ...
        var handler = new DeleteHandler(ip, sessionId, investigationIds,
                datasetIds, datafileIds);
        String body = handler.provideTransmissionBody();
        assertEquals(defaultTransmissionBodyForSessionId, body);
    }
    ...
    public void testTransmitterBodyForGetDataFileIdsRequest_shouldBeOk()
        ...
        var handler = new GetDataFileIdsHandler(ip, preparedId, null, null,
                null, null);
        String body = handler.provideTransmissionBody();
        assertEquals(defaultTransmissionBodyForPreparedId, body);

        handler = new GetDataFileIdsHandler("192.168.17.1", null, sessionId,
                investigationIds, datasetIds, datafileIds);
        body = handler.provideTransmissionBody();
        assertEquals(defaultTransmissionBodyForSessionId, body);
    }
    ...
    public void testTransmitterBodyForGetDataRequest_shouldBeOk()
        ...
        var handler = new GetDataHandler(ip, preparedId, null, null, null, null,
                false, false, "", "");
        String body = handler.provideTransmissionBody();
        assertEquals(
        ...
        handler = new GetDataHandler(ip, null, sessionId, investigationIds,
                datasetIds, datafileIds, false, false, "", "");
        body = handler.provideTransmissionBody();
        assertEquals(
    ...
    public void testTransmitterBodyForGetStatusRequest_shouldBeOk()
        ...
        var handler = new GetStatusHandler(ip, preparedId, null, null, null,
                null);
        String body = handler.provideTransmissionBody();
        assertEquals(defaultTransmissionBodyForPreparedId, body);

        handler = new GetStatusHandler(ip, null, sessionId, investigationIds,
                datasetIds, datafileIds);
        body = handler.provideTransmissionBody();
        assertEquals(defaultTransmissionBodyForSessionId, body);
    }
    ...
    public void testTransmitterBodyForPrepareDataRequest_shouldBeOk()
        ...
        var handler = new PrepareDataHandler(ip, sessionId, investigationIds,
                datasetIds, datafileIds, false, false);
        String body = handler.provideTransmissionBody();
        assertEquals(
    ...
    public void testTransmitterBodyForPutRequest_shouldBeOk() throws Exception {
        ...
        var handler = new PutHandler(ip, sessionId,
                new ByteArrayInputStream("".getBytes()), "someName",
                datafileIds, datasetIds, "someDescription", "someDOI",
                "simeCreateTimeString", "someModTimeString", false, false);
        String body = handler.provideTransmissionBody();
